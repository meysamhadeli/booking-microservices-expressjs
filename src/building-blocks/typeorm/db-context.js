...
let DbContext = class DbContext {
    ...
    async initialize(options) {
        ...
        const dataSourceOptions = {
            ...
            migrations: (options === null || options === void 0 ? void 0 : options.migrations) ? [(_k = options === null || options === void 0 ? void 0 : options.migrations) !== null && _k !== void 0 ? _k : (_l = config_1.default === null || config_1.default === void 0 ? void 0 : config_1.default.postgres) === null || _l === void 0 ? void 0 : _l.migrations] : null
        };
        try {
