...
export function RegisterRoutes(app: Router) {
  ...
  const argsCreateBookingController_createBooking: Record<string, TsoaRoute.ParameterSchema> = {
  ...
  app.post(
    ...
    async function CreateBookingController_createBooking(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCreateBookingController_createBooking,
          request,
          response
        });
